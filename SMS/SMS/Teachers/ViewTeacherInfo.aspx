<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ViewTeacherInfo.aspx.cs" Inherits="SMS.Teachers.ViewTeacherInfo" %>
...
<ClientEvents OnRequestStart="onRequestStart" />
    ...
    <telerik:RadGrid ID="GVPersonalData" DataSourceID="PersonalDataODS" runat="server"
        ...
        <MasterTableView DataSourceID="PersonalDataODS" CommandItemDisplay="Top" ShowGroupFooter="true" Width="100%" DataKeyNames="NIC">
            ...
            <Columns>
                <telerik:GridBoundColumn DataField="Employee_Name" FilterControlWidth="60px" Aggregate="Count" FooterText="Total Employees : " ShowFilterIcon="true" UniqueName="Employee_Name" HeaderText="Name"
                    MaxLength="50">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Father_Name" FilterControlWidth="60px" ShowFilterIcon="true" UniqueName="Father_Name" HeaderText="Father Name"
                    MaxLength="50">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="NIC" FilterControlWidth="60px" ShowFilterIcon="true" UniqueName="NIC" HeaderText="NIC" MaxLength="15">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Personal_No" FilterControlWidth="50px" ShowFilterIcon="true" UniqueName="Personal_No" HeaderText="Personal #"
                    MaxLength="50">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="Qualification" FilterControlWidth="50px" ShowFilterIcon="true" UniqueName="Qualification" HeaderText="Qualification"
                    MaxLength="60">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Cell_No" FilterControlWidth="60px" ShowFilterIcon="true" UniqueName="Cell_No" HeaderText="Cell #"
                    MaxLength="50">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridTemplateColumn AllowFiltering="false">
                    ...
                    <ItemTemplate>
                        <telerik:RadButton ID="btnEditInfo" CommandName="EditInfo" ButtonType="LinkButton"
                ...
                <telerik:GridTemplateColumn AllowFiltering="false">
                    ...
                    <ItemTemplate>
                        ...
                        <telerik:RadButton ID="btnAddDetailInfo" CommandName="AddDetail" ButtonType="LinkButton"
                            runat="server" Text="Add Detail Info">
                        </telerik:RadButton>
                    </ItemTemplate>
    ...
    <asp:ObjectDataSource ID="PersonalDataODS" TypeName="SMS.DAL.TeachersDetailInfoManager"
        SelectMethod="PersonalData_GetByAllByS_Id" runat="server">
        <SelectParameters>
            <asp:SessionParameter Name="schoolid" DefaultValue="0" SessionField="School_Id" Type="Int32" />
        </SelectParameters>
